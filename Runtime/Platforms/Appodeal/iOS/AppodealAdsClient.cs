...
namespace AppodealAds.Unity.Platforms.iOS
{
    ...
    public class AppodealAdsClient : IAppodealAdsClient
    {
        ...
        private static int nativeAdTypesForType(int adTypes)
        {
            ...
            if ((adTypes & AppodealAdType.BANNER) > 0 ||
                (adTypes & AppodealAdType.BANNER_VIEW) > 0 ||
                (adTypes & AppodealAdType.BANNER_TOP) > 0 ||
                (adTypes & AppodealAdType.BANNER_LEFT) > 0 ||
                (adTypes & AppodealAdType.BANNER_RIGHT) > 0 ||
                (adTypes & AppodealAdType.BANNER_BOTTOM) > 0)
            {
