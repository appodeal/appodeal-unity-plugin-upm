...
namespace AppodealAds.Unity.Platforms.Android
{
    ...
    public class AndroidAppodealClient : IAppodealAdsClient
    {
        ...
        private static int nativeAdTypesForType(int adTypes)
        {
            ...
            {
                nativeAdTypes |= AppodealAdType.INTERSTITIAL;
            }

            if ((adTypes & AppodealAdType.BANNER) > 0)
            {
                nativeAdTypes |= AppodealAdType.BANNER;
            }

            if ((adTypes & AppodealAdType.BANNER_VIEW) > 0)
            {
                nativeAdTypes |= AppodealAdType.BANNER_VIEW;
            }

            if ((adTypes & AppodealAdType.BANNER_TOP) > 0)
            {
                nativeAdTypes |= AppodealAdType.BANNER_TOP;
            }
            
            if ((adTypes & AppodealAdType.BANNER_LEFT) > 0)
            {
                nativeAdTypes |= AppodealAdType.BANNER_LEFT;
            }

            if ((adTypes & AppodealAdType.BANNER_RIGHT) > 0)
            {
                nativeAdTypes |= AppodealAdType.BANNER_RIGHT;
            }

            if ((adTypes & AppodealAdType.BANNER_BOTTOM) > 0)
            {
                nativeAdTypes |= AppodealAdType.BANNER_BOTTOM;
            }
            ...
            if ((adTypes & AppodealAdType.REWARDED_VIDEO) > 0)
            {
                nativeAdTypes |= AppodealAdType.REWARDED_VIDEO;
            }

            if ((adTypes & AppodealAdType.NON_SKIPPABLE_VIDEO) > 0)
            {
                nativeAdTypes |= AppodealAdType.REWARDED_VIDEO;
            }
