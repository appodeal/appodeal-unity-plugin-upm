...
namespace AppodealStack.Monetization.Platforms.Android
{
    internal static partial class AndroidConstants
    {
        ...
        {
            internal static class Appodeal
            {
                ...
                public const string GetSegmentId = "getSegmentId";
                public const string GetUserId = "getUserId";
                public const string GetVersion = "getVersion";
                public const string Hide = "hide";
                public const string Initialize = "initialize";
                public const string IsAutoCacheEnabled = "isAutoCacheEnabled";
                public const string IsInitialized = "isInitialized";
                public const string IsLoaded = "isLoaded";
                public const string IsPrecache = "isPrecache";
                public const string IsSmartBannersEnabled = "isSmartBannersEnabled";
                public const string LogEvent = "logEvent";
                public const string MuteVideosIfCallsMuted = "muteVideosIfCallsMuted";
                public const string SetAdRevenueCallbacks = "setAdRevenueCallbacks";
                public const string SetAutoCache = "setAutoCache";
                ...
                public const string SetFramework = "setFramework";
                ...
                public const string SetTabletBanners = "set728x90Banners";
                public const string SetTesting = "setTesting";
                public const string SetTriggerOnLoadedOnPrecache = "setTriggerOnLoadedOnPrecache";
                public const string SetUseSafeArea = "setUseSafeArea";
