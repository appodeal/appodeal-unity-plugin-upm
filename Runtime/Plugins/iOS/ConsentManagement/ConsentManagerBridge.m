...
id CmGetCustomVendor(const char *bundle) {
    if (bundle == NULL) {
        return nil;
    }
...
const char *CmShouldShowConsentDialog(void) {
...
const char *CmGetConsentZone(void) {
...
const char *CmGetConsentStatus(void) {
...
const char *CmGetIabConsentString() {
...
void CmRequestConsentInfoUpdate(const char *appodealAppKey,
...
void CmDisableAppTrackingTransparencyRequest(){
