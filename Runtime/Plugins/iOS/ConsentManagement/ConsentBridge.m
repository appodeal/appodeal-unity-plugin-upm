...
const char *ConsentGetZone(void) {
...
const char *ConsentGetStatus(void) {
...
const char *ConsentGetIabConsentString(void) {
...
const char *ConsentHasConsentForVendor(const char *bundle) {
    if (bundle == NULL) {
...
const char *ConsentGetAuthorizationStatus(void) {
