...
FOUNDATION_EXPORT void VbSetPurposeIds(const char *purposeIds);
FOUNDATION_EXPORT void VbSetFeatureIds(const char *featureIds);
FOUNDATION_EXPORT void VbSetLegitimateInterestPurposeIds(const char *legitimateInterestPurposeIds);
